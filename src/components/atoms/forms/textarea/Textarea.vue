...
<template>
  <div class="flex w-full flex-col gap-2">
    ...
    <div
      :class="
        cn(
          'relative flex w-full items-start rounded-md border bg-white shadow-xs transition-[color,border-radius] duration-150 focus-within:rounded-none hover:rounded-none',
    ...
    >
      ...
      <span
        ...
        :class="
          cn(
            'text-black-tertiary flex items-start pt-3 pr-1 pl-3',
      ...
      <textarea
        ...
        :class="
          cn(
            'placeholder:text-black-sexternary min-h-10.5 flex-1 resize-y border-none bg-transparent px-0 py-3 text-sm shadow-none outline-none',
      ...
      <span
        ...
        :class="
          cn(
            'text-black-tertiary flex items-start pt-3 pr-3 pl-1',
            props.disabled && 'text-black-quinternary',
          )
        "
        ><slot name="suffix"
      ...
      <span
        ...
        class="pointer-events-none absolute top-3 right-4 flex items-center"
      >
        <FontAwesomeIcon
