...
const classes = computed(() => ({
  "disabled:cursor-not-allowed hover:rounded-none disabled:hover:rounded-full duration-300 ease-in-out text-white flex justify-center items-center gap-2 focus:ring-2 focus:ring-offset-2 text-center focus:outline-hidden transition-[border-radius]":
    true,
