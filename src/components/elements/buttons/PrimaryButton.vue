...
const classes = computed(() => ({
  "disabled:bg-black-quinternary bg-black-primary disabled:cursor-not-allowed text-white-primary hover:rounded-none disabled:hover:rounded-full duration-300 ease-in-out flex items-center gap-3":
    true,
